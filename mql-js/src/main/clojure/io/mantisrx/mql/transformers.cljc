(ns io.mantisrx.mql.transformers
  (:require #?@(:clj [[rx.lang.clojure.core :as rx]
            ...
            [io.mantisrx.mql.compilers.core.window] ;; Force loading of this namespace for compilation reasons
            [io.mantisrx.mql.compilers.core.limit] ;; Force loading of this namespace for compilation reasons
            [io.mantisrx.mql.compilers.core.orderby] ;; Force loading of this namespace for compilation reasons
            ...
            [io.mantisrx.mql.compilers.core.groupby] ;; Force loading of this namespace for compilation reasons
            [io.mantisrx.mql.compilers.core.operands] ;; Force loading of this namespace for compilation reasons
            [io.mantisrx.mql.compilers.core.table] ;; Force loading of this namespace for compilation reasons
            [io.mantisrx.mql.compilers.core.where] ;; Force loading of this namespace for compilation reasons
            [io.mantisrx.mql.compilers.core.query] ;; Force loading of this namespace for compilation reasons
            [io.mantisrx.mql.compilers.anomaly] ;; Force loading of this namespace for compilation reasons
...
(def query->obs io.mantisrx.mql.compilers.core.query/query->obs)
(def query->observable io.mantisrx.mql.compilers.core.query/query->observable)
(def agg-query->observable io.mantisrx.mql.compilers.core.query/agg-query->observable)
;;;;
;;;; TABLE
;;;;

(def table->observable io.mantisrx.mql.compilers.core.table/table->observable)
(def from-clause->observable io.mantisrx.mql.compilers.core.table/from-clause->observable)
(def table-list->observable io.mantisrx.mql.compilers.core.table/table-list->observable)
...
(def group-by->fn io.mantisrx.mql.compilers.core.groupby/group-by->fn)

;;;;
;;;; ORDER BY
;;;;

(def order->fn io.mantisrx.mql.compilers.core.orderby/order->fn)

;;;;
;;;; LIMIT
;;;;

(def limit->fn io.mantisrx.mql.compilers.core.limit/limit->fn)

;;;;
;;;; WINDOW
;;;;

(def window->fn io.mantisrx.mql.compilers.core.window/window->fn)
(def n-window->fn io.mantisrx.mql.compilers.core.window/n-window->fn)
...
(def sample-config->extrapolation-fn io.mantisrx.mql.compilers.core.sampling/sample-config->extrapolation-fn)
(def random-sampler io.mantisrx.mql.compilers.core.sampling/random-sampler)
(def default-factor io.mantisrx.mql.compilers.core.sampling/default-factor)
...
(def mql-evaluators
  {:QUERY identity
   :NORMAL_QUERY query->observable
   :AGG_QUERY agg-query->observable
   ...
   :FROM from-clause->observable
   :table_list (partial table-list->observable {})
   :JOIN join->fn
   :TABLE table->observable
   :TABLE_NO_FROM #?(:clj (partial table->observable (rx/empty))
                     :cljs identity) ;; TODO: Unused but silly
   :HAVING io.mantisrx.mql.compilers.core.where/having-clause->fn
   :ANOMALY io.mantisrx.mql.compilers.anomaly/mad-anomaly->fn
   :GROUP group-by->fn
   :ORDER order->fn
   :SAMPLE sample-config->sampler
   :LIMIT limit->fn
   :WINDOW window->fn
   :WINDOW_N n-window->fn
